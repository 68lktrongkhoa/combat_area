...
const level90Opponent: RobotBuild = { chassis: find('chassis_heavy'), weapon: find('weapon_missile'), defense: find('defense_shield'), utility: find('utility_stealth') }; // Boss
...
const level100Opponent: RobotBuild = { chassis: find('chassis_heavy'), weapon: find('weapon_missile'), defense: find('defense_shield'), utility: find('utility_stealth') }; // ULTIMATE BOSS
